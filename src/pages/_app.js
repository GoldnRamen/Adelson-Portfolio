...
export default function App({ Component, pageProps}) {
  return (
   <RenderProvider>
     <main lang="en" className={`${roboto.className} ${lobster.className} ${saira.className} ${odibee.className}`}>
      {/* ${roboto.variable} ${lobster.variable} ${odibee.variable} ${saira.variable} */}
      <Component {...pageProps} />  
    </main>
   </RenderProvider>
  );
