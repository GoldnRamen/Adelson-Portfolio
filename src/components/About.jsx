...
export default function About(){
    ...
    return(
        <div id='About' style={{backgroundImage: `url(${lightMode ? "/paper-1074131_1280.jpg" : "/texture-2061709_640.jpg"})`, backgroundRepeat: 'no-repeat', backgroundSize: "cover"}} className='p-7 relative m-2 h-[97vh] w-full lg:opacity-80 opacity-100'>
            <div className='lg:mt-[7vh] mt-[6vh] h-[87vh] p-4 text-black absolute right-0'>                
                <div className='relative h-[35vh] w-full lg:hidden overflow-hidden'>
                    ...
                    <div style={{backgroundImage: `url(${lightMode ? "/sand-7150369_1280.jpg" : "/wall-795219_1280.jpg"})` }} className="border-3 rounded-full border-gray-900 h-fit w-fit overflow-hidden relative md:mx-auto">
                        <img className='md:h-56' src={lightMode ? '/Ade12_cut_011348.png' : `${hover ? '/Ade12bw.png' : '/Ade12_cut_011348.png'}`} alt="Public" onMouseEnter={()=>hoveringImg()} onMouseLeave={()=>hoveringImg()}/>
                    </div>
                </div>
